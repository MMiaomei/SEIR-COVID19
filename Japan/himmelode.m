...
ydot = [alpha*eta*Eq+theta*I-gammaq*Iq; %Iq
     ...
     gammaq*Iq+zeta*Aq;...%R1
     rho*phi*(epsilon*E+I+beta*A)*(Na*Pop-Iq-E-A-I-R1-Eq-R2-Aq)-alpha*Eq;...%Eq
     gammaA*A+gamma*I;...%R2
     mu*A+alpha*(1-eta)*Eq-zeta*Aq; %Aq
     ];
 
% ydot = [alpha*Eq + theta*I  - gammaq*Iq; %Iq 
%      phi*(1-rho)*(epsilon*E+I+beta*A)*(Na*Pop-Iq-E-A-I-R1-Eq-R2) - alpha*E;%E
%      alpha*(1-eta)*E - mu*A - gammaA*A;%A
%      alpha*eta*E - gamma*I - theta*I;%I
%      gammaq*Iq;%R1
%      rho*phi*(epsilon*E+I+beta*A)*(Na*Pop-Iq-E-A-I-R1-Eq-R2) - alpha*Eq;%Eq
%      gammaA*A + gamma*I ;%R2
%      mu*A -zeta*Aq; %Aq
%      ];
%    size(ydot)
